...
RELEASE_FILES = (
    ...
    *(
        ...
        for filename in (
            ...
            "exchange-manual-deliveries.csv",
            "exchange-wallet-deliveries.csv",
            "exchange-delegation-withdrawals.csv",
            "exchange-validator-vault-adjustments.csv",
            "gate-same-address-initial.csv",
            "gate-aggregated-non-initial.csv",
            "qualified-exchange-exclusions.csv",
            "exchange-routes.csv",
