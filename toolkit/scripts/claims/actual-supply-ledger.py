    ...
    try:
        with open(output_partial, "x", newline="", encoding="utf-8") as output_file:
            ...
            while (
                ...
                wallet_airdrop = (
                    liquid + undelegation + reward + pending_receipt
                )
                staked_to_vault = active
                ...
                summary["wallet_airdrop_atto"] += wallet_airdrop
                summary["staked_to_vault_atto"] += staked_to_vault
                summary["total_claim_atto"] += total_claim
